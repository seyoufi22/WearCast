...
{
    public class GetAllFactoryProductsForCustomersRequestValidator : AbstractValidator<GetAllFactoryProductsForCustomersRequest>
    {
        public GetAllFactoryProductsForCustomersRequestValidator()
        {
